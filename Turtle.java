...
/**
 ...
 public class Turtle implements  ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener, Runnable
 {
     /**
      * Demo program
      *
     ...
     {  
        ...
        bob.start();
        Thread bob2 = new Thread((new Bob2()));
        bob2.start();
        Thread bob3 = new Thread((new Bob3()));
        bob3.start();
